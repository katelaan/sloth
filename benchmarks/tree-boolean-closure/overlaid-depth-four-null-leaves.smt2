...
(declare-const dll Int)
(declare-const dlr Int)
(declare-const drl Int)
(declare-const drr Int)
(assert (sl.sepcon
         (sl.sepcon
          (sl.sepcon
          ...
          (sl.sepcon
           (sl.sepcon (sl.tree.data x dx)
                      (sl.sepcon (sl.tree.data l dl)
                                 (sl.tree.data r dr)))
           (sl.sepcon (sl.sepcon (sl.tree.data ll dll)
                                 (sl.tree.data lr dlr))
                      (sl.sepcon (sl.tree.data rl drl)
                                 (sl.tree.data rr drr))))
          )
         (sl.sepcon
          (sl.sepcon
