...
True
>>> is_in(eval_(sl.tree.seg2(t, u, v), override_bound = 4), [Graph({0, 1, 2, 3}, {(1, 'left'): 2, (1, 'right'): 3}, {'sl.tree.null': 0, 't': 1, 'u': 2, 'v': 3}), Graph({0, 1, 2, 3, 4, 5}, {(1, 'left'): 0, (1, 'right'): 2, (2, 'left'): 3, (2, 'right'): 5, (3, 'left'): 0, (3, 'right'): 4}, {'sl.tree.null': 0, 't': 1, 'u': 4, 'v': 5}), Graph({0, 1, 2, 3, 4}, {(1, 'left'): 0, (1, 'right'): 2, (2, 'left'): 3, (2, 'right'): 0, (3, 'left'): 0, (3, 'right'): 4}, {'sl.tree.null': 0, 't': 1, 'u': 0, 'v': 4})])
True
>>> eval_(sl.sepcon(sl.tree.seg2(t, u, v), sl.tree.neq(u, sl.tree.null), sl.tree.neq(v, sl.tree.null)), override_bound = 1)
Graph({0, 1, 2, 3}, {(1, 'left'): 2, (1, 'right'): 3}, {'sl.tree.null': 0, 't': 1, 'u': 2, 'v': 3})
>>> is_in(eval_(sl.tree.dpred.unary2(sl.alpha == 99, t, u, v)), [Graph({0, 1, 2, 3}, {(1, 'data'): 99, (1, 'left'): 2, (1, 'right'): 3}, {'sl.tree.null': 0, 't': 1, 'u': 2, 'v': 3}), Graph({0, 1, 2, 3, 4}, {(0, 'data'): 99, (0, 'left'): 1, (0, 'right'): 1, (2, 'data'): 99, (2, 'left'): 3, (2, 'right'): 1, (4, 'data'): 99, (4, 'left'): 0, (4, 'right'): 2}, {'a1': 0, 'a2': 2, 'sl.tree.null': 1, 't': 4, 'u': 3, 'v': 1}, {'d0': 99, 'd1': 99, 'd2': 99})])
True
